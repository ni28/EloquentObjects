...
namespace IntegrationTests
{
    ...
    public sealed class TwoWayMethodTests
    {
        ...
        public interface IContract
        {
            ...
            [EloquentMethod]
            void CallTwoWayWithParameters(int a, bool b, string s, double d, ComplexParameter p, int[] iArr, bool[] bArr, string[] sArr, double[] dArr, ComplexParameter[] pArr );
        ...
        private sealed class HostedObject : IContract
        {
            ...
            public void CallTwoWayWithParameters(int a, bool b, string s, double d, ComplexParameter p, int[] iArr, bool[] bArr, string[] sArr, double[] dArr, ComplexParameter[] pArr )
            {
